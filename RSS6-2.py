...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://jp.sunpharma.com/medicalmedicines/news.html"
GAKKAI = "サンファーマ(医療機関)"

SELECTOR_TITLE = "ul.infoList.productInfoList li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.infoList.newsList.mt40.mt25sp li"  # typo修正済み
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed6-2.xml"
