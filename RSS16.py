...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.senju.co.jp/news"
GAKKAI = "千寿製薬(ニュース)"

SELECTOR_TITLE = "ul.archive-headline li"
title_selector = "span.title"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.archive-headline li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["全てのCookieを許可"] if POPUP_MODE else [] 
