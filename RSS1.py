...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.sanofi.co.jp/ja/media-room/press-releases"
GAKKAI = "サノフィー（プレスリリース）"

SELECTOR_TITLE = "div.dotcom-press-releases-list.MuiBox-root.css-cpd9ss div.MuiBox-root.css-y36fim"
title_selector = "div.MuiTypography-root.MuiTypography-h3"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.dotcom-press-releases-list.MuiBox-root.css-cpd9ss div.MuiBox-root.css-y36fim"
date_selector = "div.MuiTypography-root.MuiTypography-body2"
date_index = 0
year_unit = "年"
month_unit = "月"
day_unit = "日"
