...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://zensei-med.jp/news/"
GAKKAI = "全星薬品(医療機関)"

SELECTOR_TITLE = "div#tab01 li"
title_selector = "span.txt"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div#tab01 li"  # typo修正済み
...
POPUP_BUTTONS = ["はい","薬局薬剤師"] if POPUP_MODE else [] 
