...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.skk-net.com/information/index.html"
GAKKAI = "三和化学(ニュース)"

SELECTOR_TITLE = "ul.newsList.mt60 li"
title_selector = "span.icon-pdf"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.newsList.mt60 li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "."
month_unit = "."
