...
# ===== 固定情報（学会サイト） =====
url = "https://www.taisho.co.jp/newsletter/2025/"
current_year = datetime.datetime.now().year

BASE_URL = re.sub(r"\d{4}", str(current_year), url, count=1)
GAKKAI = "大正製薬（ニュースレター）"

SELECTOR_TITLE = "div.column-article-list div.column-article-list__item__detail"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.column-article-list div.column-article-list__item__detail"  # typo修正済み
