...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.jcrpharm.co.jp/medical/index.html"
GAKKAI = "JCRファーマ（医療機関）"

SELECTOR_TITLE = "div#tab1 div.newsInner.type02"
title_selector = "div.post"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div#tab1 div.newsInner.type02"  # typo修正済み
