...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.shionogi.co.jp/news/package.html"
GAKKAI = "塩野義（添付文書）"

SELECTOR_TITLE = "ul#yearlist li"
title_selector = "span.mod-list-document-news__title"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul#yearlist li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "/"
month_unit = "/"
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed10-3.xml"
