...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.skk-net.com/pressrelease/index.html"
GAKKAI = "三和化学(ニュース)"

SELECTOR_TITLE = "ul.newsList.js-grid.mt80 li"
title_selector = "span.newsList_titleText"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.newsList.js-grid.mt80 li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "."
month_unit = "."
