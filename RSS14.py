...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.jnj.co.jp/media-center"
GAKKAI = "ジョンソン・エンド・ジョンソン"

SELECTOR_TITLE = "ul.GridPromo-items div.MediaPromo-content"
title_selector = "div.ResponsiveText-text"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.GridPromo-items div.MediaPromo-content"  # typo修正済み
date_selector = "div.MediaPromo-date"
date_index = 0
year_unit = "年"
month_unit = "月"
day_unit = "日"
