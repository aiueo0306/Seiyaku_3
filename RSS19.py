...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.taisho.co.jp/news/2025/"
GAKKAI = "大正製薬（ニュースリリース）"

SELECTOR_TITLE = "div.cmp-container div.column-article-list__item__detail"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.cmp-container div.column-article-list__item__detail"  # typo修正済み
date_selector = "span.column-article-list-date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""
