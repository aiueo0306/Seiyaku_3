...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://pro.csl-info.com/news/"
GAKKAI = "CSLベーリング（医療機関）"

SELECTOR_TITLE = "ul.wp-block-post-template.is-layout-flow.wp-block-post-template-is-layout-flow li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.wp-block-post-template.is-layout-flow.wp-block-post-template-is-layout-flow li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "/"
month_unit = "/"
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed11-2.xml"
